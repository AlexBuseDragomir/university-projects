...
// implementation is using Dijkstra's algorithm as a heuristic
public class AStarDijkstra
{
    ...
    public AStarDijkstra(GraphCostMatrix myGraph, Node startNode)
    {
            ...
            for(int neighbourIndex = 1; neighbourIndex <= numberOfNodes; neighbourIndex++)
            {
                ...
                if (neighbourIndex != currentNodeIndex)
                {
                    ...
                    if (!this.isVisited.get(neighbourIndex))
                    {
                        ...
                        // one of the two heuristics, using a shortest path cost (Dijkstra algortihm)
                        Dijkstra shortestPath = new Dijkstra(this.costMatrix, this.isVisited,
                                this.numberOfNodes, currentNode);
                        // we get the total cost of the shortest path and save it
                        ...
                        int finalCost = heuristicCost + costMatrix[currentNodeIndex][neighbourIndex];
